...
// async fn test_ppo_with_single_grpc_env_creates_checkpoint() {
//     type B = NdArray;
//     let device = Default::default();
//
//     // Start dummy gRPC Unity server
//     let (_handle, addr, shutdown) = start_grpc_server("127.0.0.1:0".parse().unwrap()).await.unwrap();
//
...
//
//     // Build trainer pointing to single env address
...
//     );
//
//     // Run a short train; will perform one gRPC exchange and write checkpoint
//     trainer.train();
//
